...
local _2amodule_name_2a = "curlod.aniseed.setup"
local _2amodule_2a
do
...
local a, env, eval, nvim = autoload("curlod.aniseed.core"), autoload("curlod.aniseed.env"), autoload("curlod.aniseed.eval"), autoload("curlod.aniseed.nvim")
