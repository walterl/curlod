...
local _2amodule_name_2a = "curlod.aniseed.eval"
local _2amodule_2a
do
...
local a, compile, fennel, fs, nvim = autoload("curlod.aniseed.core"), autoload("curlod.aniseed.compile"), autoload("curlod.aniseed.fennel"), autoload("curlod.aniseed.fs"), autoload("curlod.aniseed.nvim")
