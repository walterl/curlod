...
local _2amodule_name_2a = "curlod.aniseed.fennel"
local _2amodule_2a
do
...
local a, fs, nvim, str = autoload("curlod.aniseed.core"), autoload("curlod.aniseed.fs"), autoload("curlod.aniseed.nvim"), autoload("curlod.aniseed.string")
...
local function impl()
  local compiler = require("curlod.aniseed.deps.fennel")
