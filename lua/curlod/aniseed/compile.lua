...
local _2amodule_name_2a = "curlod.aniseed.compile"
local _2amodule_2a
do
...
local a, fennel, fs, nvim = autoload("curlod.aniseed.core"), autoload("curlod.aniseed.fennel"), autoload("curlod.aniseed.fs"), autoload("curlod.aniseed.nvim")
do end (_2amodule_locals_2a)["a"] = a
_2amodule_locals_2a["fennel"] = fennel
_2amodule_locals_2a["fs"] = fs
_2amodule_locals_2a["nvim"] = nvim
local function wrap_macros(code, opts)
  local macros_module = "curlod.aniseed.macros"
  local filename
  do
