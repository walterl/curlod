...
local _2amodule_name_2a = "curlod.aniseed.env"
local _2amodule_2a
do
...
local compile, fennel, fs, nvim = autoload("curlod.aniseed.compile"), autoload("curlod.aniseed.fennel"), autoload("curlod.aniseed.fs"), autoload("curlod.aniseed.nvim")
